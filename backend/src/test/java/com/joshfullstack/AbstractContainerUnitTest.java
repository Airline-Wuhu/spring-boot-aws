...
public abstract class AbstractContainerUnitTest {
    ...
    protected static final PostgreSQLContainer<?> postgreSQLContainer =
            new PostgreSQLContainer<>("postgres:latest").withDatabaseName("joshfullstack-dao-test").withUsername("joshchan").withPassword("password");
    ...
    private static DataSource getDataSource() {
        DataSourceBuilder builder = DataSourceBuilder.create()
                ...
                .username(postgreSQLContainer.getJdbcUrl())
